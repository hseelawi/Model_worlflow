...
def go(args):
    ...
    if os.path.exists("random_forest_export"):
        shutil.rmtree("random_forest_export")
    ...
    artifact.add_dir("random_forest_export")
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    sk_pipe = Pipeline([("preprocessor", preprocessor),
